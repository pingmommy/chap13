...
public class SetExample2 {
	...
	// 모든 클래스는 object를 상속받는다. 그러므로 모든 클래스는 object의 메소드를 사용할 수 있다. 
	// hashcode()메소드는 object에 소속된 메소드. 
	// hashcode()는 native로 구성되어 있는데, c언어로 만들어졌다는 뜻이다. 
	// 이것은 hashcode()가 메모리를 참조한다는 것을 의미한다. 
	static class Alpha{
	...
	public static void main3(String[] args) {
		...
		int h2 =Objects.hash(10,"hello",111.5);
